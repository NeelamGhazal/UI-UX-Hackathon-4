        ...
        <div className="container mx-auto px-4 lg:px-0 py-8 flex flex-col lg:flex-row">
          ...
          <main className="w-full lg:w-3/4 lg:pl-36 lg:mr-[2rem]">
              ...
              <article key={index} className="mb-12">
                ...
                <div className="flex flex-wrap items-center gap-3 text-[#151875] text-sm mb-6">
                  <span className="flex items-center gap-1">
                    <Image src="/images/Vector.png" alt="Icon" width={16} height={16} className="w-4 h-4" />
            ...
            <div className="flex space-x-4 sm:space-x-10 justify-center mt-8">
              <Link href="#" className="px-3 bg-pink-500 border rounded text-white">
                1
              </Link>
              <Link
                href="/singleblog"
              ...
              <Link href="#" className="px-3 bg-white border text-gray-300 rounded hover:bg-pink-500 hover:text-white">
                3
              </Link>
              <Link href="#" className="px-3 bg-white border text-gray-300 rounded hover:bg-pink-500 hover:text-white">
                4
            ...
            {/* Logos Section */}
            <div className="w-full lg:w-auto h-36 mt-8 bg-white py-20 flex items-center justify-center gap-12 overflow-x-auto">
              <Image
